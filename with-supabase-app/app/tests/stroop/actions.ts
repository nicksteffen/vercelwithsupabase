...
export interface ActivityResult {
  ...
  duration_seconds: number;
  details?: StroopDetails; // Optional details about the results
...
export async function getStroopActivitiesDetails() {
  ...
  // todo, why the heck are we relying on hardcoded IDs here? Should be dynamic or at least configurable.
